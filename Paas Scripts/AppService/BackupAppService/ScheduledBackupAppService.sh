...
az webapp config backup update --resource-group venkibackuprg --webapp-name venkiapp123 --container-url "https://venkibackupstgacc.blob.core.windows.net/venkibackupcontainer?se=2021-01-01T00%3A00%3A00Z&sp=rwdl&sv=2018-11-09&sr=c&sig=qadUGglaQcxGJu4ucGaxjvX5XcNC9vzmPLnBjTM73QU%3D" --frequency 1h --retain-one true --retention 2

# Show the current scheduled backup configuration
az webapp config backup show --resource-group venkibackuprg --webapp-name venkiapp123
...
az webapp config backup update --resource-group venkibackuprg --webapp-name venkiapp123 --container-url https://venkibackupstgacc.blob.core.windows.net/venkibackupcontainer?se=2021-01-01T00%3A00%3A00Z&sp=rwdl&sv=2018-11-09&sr=c&sig=qadUGglaQcxGJu4ucGaxjvX5XcNC9vzmPLnBjTM73QU%3D --frequency 2d --retain-one true --retention 10